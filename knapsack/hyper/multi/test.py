...
def solve(knapsack, optimal, attempts=50):
    ...
    for i in range(1, attempts + 1):
        ...
        optimal_funcs = genetic.minimize(50, weights=knapsack["weights"], costs=knapsack["costs"],
...
if __name__ == '__main__':
    knapsacks = io.parse_mknapcb(mknapcbs_pathes[0])
    lp_optimal = [lp.ksp_solve_lp_relaxed_greedy(**knapsack) for knapsack in knapsacks]
    optimals = []
    for knapsack, lp_optimal in list(zip(knapsacks, lp_optimal)):
        print("KNAPSACK:")
